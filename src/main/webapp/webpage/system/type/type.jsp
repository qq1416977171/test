...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
    ...
    <fieldset class="step">
        ...
        <div class="form"><!-- /^[A-Za-z0-9\u4E00-\u9FA5\uf900-\ufa2d\.\s]{1,50}$/   <span class="Validform_checktip"><t:mutiLang langKey="common.range1to10" /></span>-->
       ...
       <%--  <div class="form">
            <label class="Validform_label"> 文件后缀: </label>
            <input name="suffix" class="inputxt" value="${type.suffix }" >
