      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          ...
          <div class="position-relative">
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; JEECG版权所有 v_3.7.7</h4></div>
            ...
            <br/>
            <div class="center"><a  href="loginController.do?downjsp"> <h3 class="blue">文件下载</h3></a></div> 
              </div>
            </div>
          </div>
        </div>
